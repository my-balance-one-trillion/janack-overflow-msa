...
@Slf4j
@RestController
@RequestMapping("/main-service/savings")
public class SavingController {
    ...
    public ResponseEntity<?> getMonthlyAmount(@AuthenticationPrincipal NowUserDetails userDetails) {
        Users users = userDetails.getUser();
        return new ResponseEntity<>(issueService.getMonthlyAmount(users), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> getUserAccounts(@AuthenticationPrincipal NowUserDetails userDetails) {
        Users users = userDetails.getUser();
        return new ResponseEntity<>(inputAccountService.getAccountsByUser(users), HttpStatus.OK);
    }
